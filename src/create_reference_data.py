...
REFERENCE_FILE = "reference_BCA-200uL-2.csv"
...
if __name__ == "__main__":
    ...
    try:
        ...
        reference_data = pd.DataFrame(columns=["Red_Frequency", "Green_Frequency", "Blue_Frequency", "Clear_Frequency", "Red", "Green", "Blue", "Label"])
        previous_label = None
        index = 0
        loop = True # main loop
